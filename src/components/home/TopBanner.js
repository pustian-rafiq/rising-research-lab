        ...
        <>
            <Box sx={{ display: 'flex' }}>
                <Box sx={myStyle} style={!menu ? { width: '50%', display: 'inline-block' } : { width: '100%' }} >
                    <Box sx={{ marginTop: '10%' }}>
                        <Box position="static" style={!menu ? { display: 'none' } : { width: '100%' }} >
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'transparent', padding: '60px 30px' }}>
                                <Typography
                                    variant="h6"
                                    noWrap
                                    component="a"
                    ...
                    <Box sx={{  display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center' }}>
                        <Typography sx={{ fontSize: '36px', fontWeight: 'bold',   color: '#fff' }}>
                        ...
                        sx={{width:'50%'}}
                            ...
                            includeInputInList
                            renderInput={(params) => (
                                <TextField {...params} label="#" variant="standard" sx={{background:'transparent'}} />
                            )}
                        />
                    </Box>
                </Box>
